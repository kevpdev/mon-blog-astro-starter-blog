...
export const socialLinksConfig: SocialLinksConfig = [
  {
    ...
    ariaLabel: 'Follow Astro on Mastodon',
    icon: `<svg viewBox="0 0 16 16" aria-hidden="true" width="32" height="32">
  ...
  },
  {
    ...
    ariaLabel: 'Follow Astro on Twitter',
    icon: `<svg viewBox="0 0 16 16" aria-hidden="true" width="32" height="32">
  ...
  },
  {
    ...
    ariaLabel: "Go to Astro's GitHub repo",
    icon: `<svg viewBox="0 0 16 16" aria-hidden="true" width="32" height="32">
